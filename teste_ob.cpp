...
int main()
{
    ...
    Luz *luz = new Luz(Point3D(0, 10, 12), 0.3, 0.3, 0.3);
    Luz *luz2 = new Luz(Point3D(0, 0, -10), 0.3, 0.3, 0.3);
    Plane *plano = new Plane(Point3D(100, 0, 0), Vector3D(0.2, 0.2, 0.2));
    Plane *plano2 = new Plane(Point3D(-100, 0, 0), Vector3D(0.2, 0.2, 0.2));
